...
<div class='top-div'>
	<div class='pageheight'>
		<div class='center'>
			<h1 class='title typing-style' data-theme={$theme} id='home'>
		...
		<img
			...
			class='profileimage'
			data-theme={$theme}
			src={'/public/static/.images/profilepic.png'}
		/>
		<p class='carved' data-theme={$theme}>
			...
			experience. But if you really want to get to know me, be sure to check out the <a class='link' data-theme={$theme}
																																												href='#about'
	...
	<div class='pageheight'>
		<h1 class='title' data-theme={$theme} id='experience'>Experience & Projects</h1>
		<svelte:component this={experienceCard} />
	</div>

	<div>
		<h1 class='title' data-theme={$theme} id='contact'></h1>
